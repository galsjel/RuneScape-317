...
public class Class7 {
	...
	public static int method184(int i, int i_216_, int i_217_, int i_218_) {
		int i_219_ = (65536 - Class30_Sub2_Sub1_Sub3.anIntArray1471[i_217_ * 1024 / i_218_] >> 1);
	...
	public static void method188(Class25 class25, int i, int i_226_, int i_227_, int i_228_, Class11 class11, int[][][] is, int i_229_, int i_230_, int i_231_) {
		...
		if (i_227_ == 22) {
			...
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(22, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, 22, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			...
			Class30_Sub2_Sub4 class30_sub2_sub4;
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(10, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, 10, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			if (class30_sub2_sub4 != null) {
				...
				class25.method284(i_238_, i_239_, i_237_, i_242_, class30_sub2_sub4, i_241_, i_231_, i_240_, i_226_, i_229_);
			}
			if (class46.aBoolean767) {
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i_229_, i_226_, i);
			}
		} else if (i_227_ >= 12) {
			Class30_Sub2_Sub4 class30_sub2_sub4;
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(i_227_, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, i_227_, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			class25.method284(i_238_, i_239_, i_237_, 1, class30_sub2_sub4, 1, i_231_, 0, i_226_, i_229_);
			if (class46.aBoolean767) {
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i_229_, i_226_, i);
			}
		} else if (i_227_ == 0) {
			Class30_Sub2_Sub4 class30_sub2_sub4;
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(0, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, 0, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			class25.method282(anIntArray152[i], class30_sub2_sub4, i_238_, i_226_, i_239_, i_229_, null, i_237_, 0, i_231_);
			if (class46.aBoolean767) {
				class11.method211(i_226_, i, i_229_, i_227_, class46.aBoolean757);
			}
		} else if (i_227_ == 1) {
			Class30_Sub2_Sub4 class30_sub2_sub4;
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(1, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, 1, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			class25.method282(anIntArray140[i], class30_sub2_sub4, i_238_, i_226_, i_239_, i_229_, null, i_237_, 0, i_231_);
			if (class46.aBoolean767) {
				class11.method211(i_226_, i, i_229_, i_227_, class46.aBoolean757);
			}
		} else if (i_227_ == 2) {
			...
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(2, 4 + i, i_233_, i_234_, i_235_, i_236_, -1);
				class30_sub2_sub4_244_ = class46.method578(2, i_243_, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, 4 + i, 2, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
				class30_sub2_sub4_244_ = new Class30_Sub2_Sub4_Sub5(i_230_, i_243_, 2, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			class25.method282(anIntArray152[i], class30_sub2_sub4, i_238_, i_226_, i_239_, i_229_, class30_sub2_sub4_244_, i_237_, anIntArray152[i_243_], i_231_);
			if (class46.aBoolean767) {
				class11.method211(i_226_, i, i_229_, i_227_, class46.aBoolean757);
			}
		} else if (i_227_ == 3) {
			Class30_Sub2_Sub4 class30_sub2_sub4;
			if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
				class30_sub2_sub4 = class46.method578(3, i, i_233_, i_234_, i_235_, i_236_, -1);
			} else {
				class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, i, 3, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
			}
			class25.method282(anIntArray140[i], class30_sub2_sub4, i_238_, i_226_, i_239_, i_229_, null, i_237_, 0, i_231_);
			if (class46.aBoolean767) {
				class11.method211(i_226_, i, i_229_, i_227_, class46.aBoolean757);
			...
			if (i_227_ == 4) {
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					...
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_230_, 0, 4, i_234_, i_235_, i_233_, i_236_, class46.anInt781, true);
				}
				class25.method283(i_238_, i_226_, i * 512, i_231_, 0, i_237_, class30_sub2_sub4, i_229_, i_239_, 0, anIntArray152[i]);
			} else if (i_227_ == 5) {
				int i_248_ = 16;
				...
				class25.method283(i_238_, i_226_, i * 512, i_231_, anIntArray137[i] * i_248_, i_237_, class30_sub2_sub4, i_229_, i_239_, anIntArray144[i] * i_248_, anIntArray152[i]);
			} else if (i_227_ == 6) {
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(4, 0, i_233_, i_234_, i_235_, i_236_, -1);
				...
				class25.method283(i_238_, i_226_, i, i_231_, 0, i_237_, class30_sub2_sub4, i_229_, i_239_, 0, 256);
			} else if (i_227_ == 7) {
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(4, 0, i_233_, i_234_, i_235_, i_236_, -1);
				...
				class25.method283(i_238_, i_226_, i, i_231_, 0, i_237_, class30_sub2_sub4, i_229_, i_239_, 0, 512);
			} else if (i_227_ == 8) {
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(4, 0, i_233_, i_234_, i_235_, i_236_, -1);
				...
				class25.method283(i_238_, i_226_, i, i_231_, 0, i_237_, class30_sub2_sub4, i_229_, i_239_, 0, 768);
			}
		}
	}
	...
	public static boolean method189(int i, byte[] is, int i_250_) {
		boolean bool = true;
		Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(is);
		int i_252_ = -1;
		for (; ; ) {
	...
	public void method171(Class11[] class11s, Class25 class25) {
		...
		for (int i_10_ = 0; i_10_ < 4; i_10_++) {
						...
						if (i_40_ >= 1 && i_40_ < anInt147 - 1 && (!aBoolean151 || (aByteArrayArrayArray149[0][i_29_][i_40_] & 0x2) != 0 || ((aByteArrayArrayArray149[i_10_][i_29_][i_40_] & 0x10) == 0 && (method182(i_40_, i_10_, i_29_, 0) == anInt131)))) {
							...
							if (i_43_ > 0 || i_44_ > 0) {
								...
								if (i_10_ > 0) {
									...
									if (i_44_ > 0 && !(Class22.aClass22Array388[i_44_ - 1].aBoolean393)) {
										bool = false;
									}
								...
								int i_58_ = 0;
								if (i_53_ != -1) {
									i_58_ = (Class30_Sub2_Sub1_Sub3.anIntArray1482[method187(i_54_, 96)]);
								}
								if (i_44_ == 0) {
									...
									Class22 class22 = Class22.aClass22Array388[i_44_ - 1];
									...
									if (i_61_ >= 0) {
										...
										i_63_ = method177(class22.anInt394, class22.anInt395, class22.anInt396);
										i_62_ = (Class30_Sub2_Sub1_Sub3.anIntArray1482[method185(class22.anInt399, 96)]);
									}
									class25.method279(i_10_, i_29_, i_40_, i_59_, i_60_, i_61_, i_45_, i_46_, i_47_, i_48_, method187(i_53_, i_49_), method187(i_53_, i_50_), method187(i_53_, i_51_), method187(i_53_, i_52_), method185(i_63_, i_49_), method185(i_63_, i_50_), method185(i_63_, i_51_), method185(i_63_, i_52_), i_58_, i_62_);
								}
							}
						}
					}
			...
			for (int i_64_ = 1; i_64_ < anInt147 - 1; i_64_++) {
				for (int i_65_ = 1; i_65_ < anInt146 - 1; i_65_++) {
					class25.method278(i_10_, i_65_, i_64_, method182(i_64_, i_10_, i_65_, 0));
				}
			}
		}
					...
					for (int i_74_ = 0; i_74_ <= anInt146; i_74_++) {
						if ((anIntArrayArrayArray135[i_72_][i_74_][i_73_] & i_68_) != 0) {
							...
							if (i_81_ >= 8) {
								...
								Class25.method277(i_71_, i_74_ * 128, i_84_, i_74_ * 128, i_76_ * 128 + 128, i_83_, i_75_ * 128, 1);
						...
						if ((anIntArrayArrayArray135[i_72_][i_74_][i_73_] & i_69_) != 0) {
							...
							if (i_93_ >= 8) {
								...
								Class25.method277(i_71_, i_87_ * 128, i_96_, i_88_ * 128 + 128, i_73_ * 128, i_95_, i_73_ * 128, 2);
						...
						if ((anIntArrayArrayArray135[i_72_][i_74_][i_73_] & i_70_) != 0) {
							...
							if ((i_100_ - i_99_ + 1) * (i_102_ - i_101_ + 1) >= 4) {
								...
								Class25.method277(i_71_, i_99_ * 128, i_105_, i_100_ * 128 + 128, i_102_ * 128 + 128, i_105_, i_101_ * 128, 4);
	...
	public void method175(int i, Class25 class25, Class11 class11, int i_119_, int i_120_, int i_121_, int i_122_, boolean bool, int i_123_) {
		...
		if (!bool) {
			if (i_119_ == 22) {
				if (!aBoolean151 || class46.aBoolean778 || class46.aBoolean736) {
					Class30_Sub2_Sub4 class30_sub2_sub4;
					if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
						class30_sub2_sub4 = class46.method578(22, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
					} else {
						class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, 22, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
					}
				...
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(10, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, 10, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				if (class30_sub2_sub4 != null) {
					int i_131_ = 0;
					if (i_119_ == 11) {
					...
					if (class25.method284(i_129_, i_130_, i_128_, i_133_, class30_sub2_sub4, i_132_, i_120_, i_131_, i, i_121_) && class46.aBoolean779) {
						Class30_Sub2_Sub4_Sub6 class30_sub2_sub4_sub6;
						if (class30_sub2_sub4 instanceof Class30_Sub2_Sub4_Sub6) {
							class30_sub2_sub4_sub6 = (Class30_Sub2_Sub4_Sub6) class30_sub2_sub4;
						} else {
							class30_sub2_sub4_sub6 = class46.method578(10, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
						}
						if (class30_sub2_sub4_sub6 != null) {
							for (int i_134_ = 0; i_134_ <= i_132_; i_134_++) {
								for (int i_135_ = 0; i_135_ <= i_133_; i_135_++) {
									int i_136_ = class30_sub2_sub4_sub6.anInt1650 / 4;
									if (i_136_ > 30) {
										i_136_ = 30;
									}
				...
				if (class46.aBoolean767 && class11 != null) {
					class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i_121_, i, i_123_);
				}
			} else if (i_119_ >= 12) {
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(i_119_, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, i_119_, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				class25.method284(i_129_, i_130_, i_128_, 1, class30_sub2_sub4, 1, i_120_, 0, i, i_121_);
				...
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(0, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, 0, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				class25.method282(anIntArray152[i_123_], class30_sub2_sub4, i_129_, i, i_130_, i_121_, null, i_128_, 0, i_120_);
				if (i_123_ == 0) {
				...
				if (class46.aBoolean767 && class11 != null) {
					class11.method211(i, i_123_, i_121_, i_119_, class46.aBoolean757);
				}
				if (class46.anInt775 != 16) {
					class25.method290(i, class46.anInt775, i_121_, i_120_);
				}
			} else if (i_119_ == 1) {
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(1, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, 1, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				class25.method282(anIntArray140[i_123_], class30_sub2_sub4, i_129_, i, i_130_, i_121_, null, i_128_, 0, i_120_);
				if (class46.aBoolean779) {
					if (i_123_ == 0) {
						aByteArrayArrayArray134[i_120_][i_121_][i + 1] = (byte) 50;
					} else if (i_123_ == 1) {
				...
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(2, 4 + i_123_, i_124_, i_125_, i_126_, i_127_, -1);
					class30_sub2_sub4_138_ = class46.method578(2, i_137_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, 4 + i_123_, 2, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
					class30_sub2_sub4_138_ = new Class30_Sub2_Sub4_Sub5(i_122_, i_137_, 2, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				class25.method282(anIntArray152[i_123_], class30_sub2_sub4, i_129_, i, i_130_, i_121_, class30_sub2_sub4_138_, i_128_, anIntArray152[i_137_], i_120_);
				if (class46.aBoolean764) {
					if (i_123_ == 0) {
						anIntArrayArrayArray135[i_120_][i_121_][i] |= 0x249;
						anIntArrayArrayArray135[i_120_][i_121_][i + 1] |= 0x492;
				...
				Class30_Sub2_Sub4 class30_sub2_sub4;
				if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
					class30_sub2_sub4 = class46.method578(3, i_123_, i_124_, i_125_, i_126_, i_127_, -1);
				} else {
					class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, i_123_, 3, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
				}
				class25.method282(anIntArray140[i_123_], class30_sub2_sub4, i_129_, i, i_130_, i_121_, null, i_128_, 0, i_120_);
				if (class46.aBoolean779) {
					if (i_123_ == 0) {
				...
				if (i_119_ == 4) {
					Class30_Sub2_Sub4 class30_sub2_sub4;
					if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
						class30_sub2_sub4 = class46.method578(4, 0, i_124_, i_125_, i_126_, i_127_, -1);
					} else {
						class30_sub2_sub4 = new Class30_Sub2_Sub4_Sub5(i_122_, 0, 4, i_125_, i_126_, i_124_, i_127_, class46.anInt781, true);
					}
					class25.method283(i_129_, i, i_123_ * 512, i_120_, 0, i_128_, class30_sub2_sub4, i_121_, i_130_, 0, anIntArray152[i_123_]);
				} else if (i_119_ == 5) {
					int i_142_ = 16;
					...
					class25.method283(i_129_, i, i_123_ * 512, i_120_, anIntArray137[i_123_] * i_142_, i_128_, class30_sub2_sub4, i_121_, i_130_, anIntArray144[i_123_] * i_142_, anIntArray152[i_123_]);
				} else if (i_119_ == 6) {
					Class30_Sub2_Sub4 class30_sub2_sub4;
					if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
						class30_sub2_sub4 = class46.method578(4, 0, i_124_, i_125_, i_126_, i_127_, -1);
					...
					class25.method283(i_129_, i, i_123_, i_120_, 0, i_128_, class30_sub2_sub4, i_121_, i_130_, 0, 256);
				} else if (i_119_ == 7) {
					Class30_Sub2_Sub4 class30_sub2_sub4;
					if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
						class30_sub2_sub4 = class46.method578(4, 0, i_124_, i_125_, i_126_, i_127_, -1);
					...
					class25.method283(i_129_, i, i_123_, i_120_, 0, i_128_, class30_sub2_sub4, i_121_, i_130_, 0, 512);
				} else if (i_119_ == 8) {
					Class30_Sub2_Sub4 class30_sub2_sub4;
					if (class46.anInt781 == -1 && class46.anIntArray759 == null) {
						class30_sub2_sub4 = class46.method578(4, 0, i_124_, i_125_, i_126_, i_127_, -1);
					...
					class25.method283(i_129_, i, i_123_, i_120_, 0, i_128_, class30_sub2_sub4, i_121_, i_130_, 0, 768);
				}
			}
		}
	}
	...
	public void method179(int i, int i_162_, Class11[] class11s, int i_164_, int i_165_, byte[] is, int i_166_, int i_167_, int i_168_) {
		for (int i_169_ = 0; i_169_ < 8; i_169_++) {
			for (int i_170_ = 0; i_170_ < 8; i_170_++) {
				if (i_164_ + i_169_ > 0 && i_164_ + i_169_ < 103 && i_168_ + i_170_ > 0 && i_168_ + i_170_ < 103) {
					class11s[i_167_].anIntArrayArray294[i_164_ + i_169_][(i_168_ + i_170_)] &= ~0x1000000;
				}
			}
		}
		Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(is);
			...
			for (int i_173_ = 0; i_173_ < 64; i_173_++) {
				for (int i_174_ = 0; i_174_ < 64; i_174_++) {
					if (i_172_ == i && i_173_ >= i_165_ && i_173_ < i_165_ + 8 && i_174_ >= i_166_ && i_174_ < i_166_ + 8) {
						method181(i_168_ + Class4.method156(i_174_ & 0x7, i_162_, i_173_ & 0x7), 0, class30_sub2_sub2, i_164_ + Class4.method155(i_162_, i_174_ & 0x7, i_173_ & 0x7), i_167_, i_162_, 0);
					} else {
						method181(-1, 0, class30_sub2_sub2, -1, 0, 0, 0);
					}
				}
			}
		}
	...
	public void method180(byte[] is, int i, int i_175_, int i_176_, int i_177_, Class11[] class11s) {
			...
			for (int i_180_ = 0; i_180_ < 64; i_180_++) {
				for (int i_181_ = 0; i_181_ < 64; i_181_++) {
					if (i_175_ + i_180_ > 0 && i_175_ + i_180_ < 103 && i + i_181_ > 0 && i + i_181_ < 103) {
						class11s[i_179_].anIntArrayArray294[i_175_ + i_180_][i + i_181_] &= ~0x1000000;
					}
				}
			}
		}
		...
		for (int i_182_ = 0; i_182_ < 4; i_182_++) {
			for (int i_183_ = 0; i_183_ < 64; i_183_++) {
				for (int i_184_ = 0; i_184_ < 64; i_184_++) {
					method181(i_184_ + i, i_177_, class30_sub2_sub2, i_183_ + i_175_, i_182_, 0, i_176_);
				}
			}
		}
	}

	public void method181(int i, int i_185_, Class30_Sub2_Sub2 class30_sub2_sub2, int i_186_, int i_187_, int i_188_, int i_190_) {
		if (i_186_ >= 0 && i_186_ < 104 && i >= 0 && i < 104) {
			...
			for (; ; ) {
				...
				if (i_191_ <= 49) {
					aByteArrayArrayArray130[i_187_][i_186_][i] = class30_sub2_sub2.method409();
	...
	public void method183(Class11[] class11s, Class25 class25, int i, int i_197_, int i_198_, int i_199_, byte[] is, int i_200_, int i_201_, int i_202_) {
		Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(is);
		int i_203_ = -1;
		for (; ; ) {
			...
			for (; ; ) {
				...
				if (i_209_ == i && i_208_ >= i_200_ && i_208_ < i_200_ + 8 && i_207_ >= i_198_ && i_207_ < i_198_ + 8) {
					...
					int i_213_ = i_197_ + Class4.method157(i_201_, class46.anInt761, i_208_ & 0x7, i_207_ & 0x7, class46.anInt744);
					int i_214_ = i_202_ + Class4.method158(i_207_ & 0x7, class46.anInt761, i_201_, class46.anInt744, i_208_ & 0x7);
					if (i_213_ > 0 && i_214_ > 0 && i_213_ < 103 && i_214_ < 103) {
						...
						method175(i_214_, class25, class11, i_211_, i_199_, i_213_, i_203_, false, i_212_ + i_201_ & 0x3);
					}
				}
			}
		}
	...
	public void method190(int i, Class11[] class11s, int i_263_, Class25 class25, byte[] is) {
		Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(is);
		int i_265_ = -1;
		for (; ; ) {
			...
			for (; ; ) {
				...
				if (i_275_ > 0 && i_276_ > 0 && i_275_ < 103 && i_276_ < 103) {
					...
					method175(i_276_, class25, class11, i_273_, i_271_, i_275_, i_265_, false, i_274_);
				}
			}
		}
	}
