...
public class Class6 {
	...
	public Class29 aClass29_98;
	public Class29 aClass29_99;
	public Class29 aClass29_100;
	public Class29 aClass29_101;
	public Class29 aClass29_102;
	public Class29 aClass29_103;
	public Class29 aClass29_104;
	public Class29 aClass29_105;
	...
	public int[] method167(int i, int j) {
		...
		aClass29_98.method327();
		aClass29_99.method327();
		int l = 0;
		int i1 = 0;
		int j1 = 0;
		if (aClass29_100 != null) {
			aClass29_100.method327();
			aClass29_101.method327();
		...
		if (aClass29_102 != null) {
			aClass29_102.method327();
			aClass29_103.method327();
	...
	public void method169(Class30_Sub2_Sub2 class30_sub2_sub2) {
		aClass29_98 = new Class29();
		aClass29_98.method325(class30_sub2_sub2);
		aClass29_99 = new Class29();
		aClass29_99.method325(class30_sub2_sub2);
		int i = class30_sub2_sub2.method408();
		if (i != 0) {
			class30_sub2_sub2.anInt1406--;
			aClass29_100 = new Class29();
			aClass29_100.method325(class30_sub2_sub2);
			aClass29_101 = new Class29();
			aClass29_101.method325(class30_sub2_sub2);
		}
		i = class30_sub2_sub2.method408();
		if (i != 0) {
			class30_sub2_sub2.anInt1406--;
			aClass29_102 = new Class29();
			aClass29_102.method325(class30_sub2_sub2);
			aClass29_103 = new Class29();
			aClass29_103.method325(class30_sub2_sub2);
		}
		i = class30_sub2_sub2.method408();
		if (i != 0) {
			class30_sub2_sub2.anInt1406--;
			aClass29_104 = new Class29();
			aClass29_104.method325(class30_sub2_sub2);
			aClass29_105 = new Class29();
			aClass29_105.method325(class30_sub2_sub2);
		}
		for (int j = 0; j < 10; j++) {
