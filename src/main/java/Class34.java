...
public class Class34 {
	...
	public static void method487(Class44 class44) {
		Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(class44.method571("fragmentsenc.txt", null));
		Class30_Sub2_Sub2 class30_sub2_sub2_1 = new Class30_Sub2_Sub2(class44.method571("badenc.txt", null));
		Class30_Sub2_Sub2 class30_sub2_sub2_2 = new Class30_Sub2_Sub2(class44.method571("domainenc.txt", null));
		Class30_Sub2_Sub2 class30_sub2_sub2_3 = new Class30_Sub2_Sub2(class44.method571("tldlist.txt", null));
	...
	public static void method488(Class30_Sub2_Sub2 class30_sub2_sub2, Class30_Sub2_Sub2 class30_sub2_sub2_1, Class30_Sub2_Sub2 class30_sub2_sub2_2, Class30_Sub2_Sub2 class30_sub2_sub2_3) {
		method490(class30_sub2_sub2_1);
		method491(class30_sub2_sub2_2);
		method492(class30_sub2_sub2);
		method489(class30_sub2_sub2_3);
	}

	public static void method489(Class30_Sub2_Sub2 class30_sub2_sub2) {
	...
	public static void method490(Class30_Sub2_Sub2 class30_sub2_sub2) {
		int j = class30_sub2_sub2.method413();
		aCharArrayArray621 = new char[j][];
		aByteArrayArrayArray622 = new byte[j][][];
		method493(class30_sub2_sub2, aCharArrayArray621, aByteArrayArrayArray622);
	}

	public static void method491(Class30_Sub2_Sub2 class30_sub2_sub2) {
		int i = class30_sub2_sub2.method413();
		aCharArrayArray623 = new char[i][];
		method494(aCharArrayArray623, class30_sub2_sub2, -490);
	}

	public static void method492(Class30_Sub2_Sub2 class30_sub2_sub2) {
	...
	public static void method493(Class30_Sub2_Sub2 class30_sub2_sub2, char[][] ac, byte[][][] abyte0) {
	...
	public static void method495(char[] ac) {
		int i = 0;
		for (int j = 0; j < ac.length; j++) {
			if (method496(ac[j])) {
				ac[i] = ac[j];
	...
	public static String method497(String s, int i) {
		...
		for (String value : aStringArray626) {
			for (int k = -1; (k = s2.indexOf(value, k + 1)) != -1; ) {
	...
	public static void method500(char[] ac) {
		for (int i = 0; i < 2; i++) {
	...
	public static void method501(char[] ac) {
		char[] ac1 = ac.clone();
		char[] ac2 = {'(', 'a', ')'};
	...
	public static void method502(char[] ac, char[] ac1, char[] ac2, char[] ac3) {
	...
	public static void method505(char[] ac) {
		char[] ac1 = ac.clone();
		char[] ac2 = {'d', 'o', 't'};
		method509(null, ac1, ac2);
		char[] ac3 = ac.clone();
	...
	public static void method506(char[] ac, char[] ac1, int i, char[] ac2, char[] ac3) {
	...
	public static int method511(char c, char c1, char c2) {
		if (c1 == c) {
			return 1;
		}
		if (c1 == 'o' && c == '0') {
	...
	public static void method514(char[] ac) {
		int j;
		int k = 0;
		int l = 0;
		int i1 = 0;
	...
	public static boolean method517(char c) {
		return !method519(c) && !method520(c);
	}
