	...
	public static void method374(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		if (i <= j && i <= k) {
			...
			if (i != k && j3 < j2 || i == k && l2 > j2) {
				...
				for (i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.anInt1379) {
					method375(Class30_Sub2_Sub1.anIntArray1378, i, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
					i1 += j3;
					l += j2;
					l1 += k3;
					k1 += k2;
			...
			k -= i;
			for (i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.anInt1379) {
				method375(Class30_Sub2_Sub1.anIntArray1378, i, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
				i1 += j3;
				l += j2;
				l1 += k3;
				k1 += k2;
		...
		if (j <= k) {
			...
			if (j2 < l2) {
				...
				for (j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.anInt1379) {
					method375(Class30_Sub2_Sub1.anIntArray1378, j, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
					j1 += j2;
					i1 += l2;
					i2 += k2;
					l1 += i3;
			...
			i -= j;
			for (j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.anInt1379) {
				method375(Class30_Sub2_Sub1.anIntArray1378, j, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
				j1 += j2;
				i1 += l2;
				i2 += k2;
				l1 += i3;
		...
		if (l2 < j3) {
			...
			for (k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.anInt1379) {
				method375(Class30_Sub2_Sub1.anIntArray1378, k, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
				l += l2;
				j1 += j3;
				k1 += i3;
				i2 += k3;
		...
		j -= k;
		for (k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.anInt1379) {
			method375(Class30_Sub2_Sub1.anIntArray1378, k, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
			l += l2;
			j1 += j3;
			k1 += i3;
			i2 += k3;
	...
	public static void method376(int i, int j, int k, int l, int i1, int j1, int k1) {
		...
		if (i <= j && i <= k) {
			...
			if (i != k && j2 < l1 || i == k && i2 > l1) {
				...
				k -= i;
				for (i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.anInt1379) {
					method377(Class30_Sub2_Sub1.anIntArray1378, i, k1, i1 >> 16, l >> 16);
					i1 += j2;
					l += l1;
				}
			...
			k -= i;
			for (i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.anInt1379) {
				method377(Class30_Sub2_Sub1.anIntArray1378, i, k1, l >> 16, i1 >> 16);
				i1 += j2;
				l += l1;
			}
		...
		if (j <= k) {
			...
			if (l1 < i2) {
				...
				i -= j;
				for (j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.anInt1379) {
					method377(Class30_Sub2_Sub1.anIntArray1378, j, k1, j1 >> 16, i1 >> 16);
					j1 += l1;
					i1 += i2;
				}
			...
			i -= j;
			for (j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.anInt1379) {
				method377(Class30_Sub2_Sub1.anIntArray1378, j, k1, i1 >> 16, j1 >> 16);
				j1 += l1;
				i1 += i2;
			}
		...
		if (i2 < j2) {
			...
			j -= k;
			for (k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.anInt1379) {
				method377(Class30_Sub2_Sub1.anIntArray1378, k, k1, l >> 16, j1 >> 16);
				l += i2;
				j1 += j2;
			}
		...
		j -= k;
		for (k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.anInt1379) {
			method377(Class30_Sub2_Sub1.anIntArray1378, k, k1, j1 >> 16, l >> 16);
			l += i2;
			j1 += j2;
		}
