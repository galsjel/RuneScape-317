...
public class Class13 {
	...
	public static final Class32 aClass32_305 = new Class32();
	...
	public static void method226(Class32 class32) {
	...
	public static void method227(Class32 class32) {
		int k8 = 0;
		int[] ai = null;
		int[] ai1 = null;
		int[] ai2 = null;
	...
	public static byte method228(Class32 class32) {
		return (byte) method230(8, class32);
	}

	public static byte method229(Class32 class32) {
		return (byte) method230(1, class32);
	}

	public static int method230(int i, Class32 class32) {
		int j;
		do {
	...
	public static void method231(Class32 class32) {
		class32.anInt588 = 0;
		for (int i = 0; i < 256; i++) {
